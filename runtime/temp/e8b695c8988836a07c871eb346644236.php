<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/Users/soutensakai/Desktop/canyin/public/../application/admin/view/dashboard/index.html";i:1585190149;s:76:"/Users/soutensakai/Desktop/canyin/application/admin/view/layout/default.html";i:1585210989;s:73:"/Users/soutensakai/Desktop/canyin/application/admin/view/common/meta.html";i:1585190150;s:75:"/Users/soutensakai/Desktop/canyin/application/admin/view/common/script.html";i:1585190150;}*/ ?>
<!DOCTYPE html>
...
<!--&lt;!&ndash;                                <?php echo __('Total user'); ?>&ndash;&gt;-->
<!--                                总商户数-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--&lt;!&ndash;                    <div class="col-sm-3 col-xs-6">&ndash;&gt;-->
<!--&lt;!&ndash;                        <div class="sm-st clearfix">&ndash;&gt;-->
<!--&lt;!&ndash;                            <span class="sm-st-icon st-violet"><i class="fa fa-book"></i></span>&ndash;&gt;-->
<!--&lt;!&ndash;                            <div class="sm-st-info">&ndash;&gt;-->
<!--&lt;!&ndash;                                <span><?php echo $totalviews; ?></span>&ndash;&gt;-->
<!--&lt;!&ndash;                                <?php echo __('Total view'); ?>&ndash;&gt;-->
<!--&lt;!&ndash;                            </div>&ndash;&gt;-->
<!--&lt;!&ndash;                        </div>&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--                    <div class="col-sm-3 col-xs-6">-->
...
<!--&lt;!&ndash;                                <?php echo __('Total order'); ?>&ndash;&gt;-->
<!--                                交易数量-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--&lt;!&ndash;                                <?php echo __('Total order amount'); ?>&ndash;&gt;-->
<!--                                交易金额-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div id="echart" class="btn-refresh" style="height:300px;width:100%;margin-top: 50px;"></div>
                    </div>
                    <div class="col-lg-4">
