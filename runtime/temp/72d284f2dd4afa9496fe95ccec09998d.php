...
<!--                                </ol>-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input data-rule="required" id="c-c_partner_code" class="form-control" name="row[c_partner_code]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input data-rule="required" id="c-c_merchant_name" class="form-control" name="row[c_merchant_name]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">商户简称</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_short_name" class="form-control" name="row[c_short_name]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_tel" class="form-control" name="row[c_tel]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_service_phone" class="form-control" name="row[c_service_phone]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_name" class="form-control" name="row[c_name]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_bank" class="form-control" name="row[c_bank]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_bank_code" class="form-control" name="row[c_bank_code]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_feedback_email" class="form-control" name="row[c_feedback_email]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_alipay_no" class="form-control" name="row[c_alipay_no]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-c_id_card_no" class="form-control" name="row[c_id_card_no]" type="text" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_id_card_img_f" data-rule="" class="form-control" size="100" name="row[c_id_card_img_f]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_id_card_b_img" data-rule="" class="form-control" size="100" name="row[c_id_card_b_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_license_img" data-rule="" class="form-control" size="100" name="row[c_license_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_store_quanjing_img" data-rule="" class="form-control" size="100" name="row[c_store_quanjing_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_store_shouyintai_img" data-rule="" class="form-control" size="100" name="row[c_store_shouyintai_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_store_zhaopai_img" data-rule="" class="form-control" size="100" name="row[c_store_zhaopai_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" >
            <div class="input-group">
                <input  id="c-c_service_permit_img" data-rule="" class="form-control" size="100" name="row[c_service_permit_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
